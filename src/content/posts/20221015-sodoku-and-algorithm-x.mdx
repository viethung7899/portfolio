---
title: Sodoku and Algorithm X
date: 2022-10-15
---

import SodokuSolver from '@interactives/sodoku/SodokuSolver.svelte'
import MobileWrapper from '@interactives/MobileWrapper.svelte'

<MobileWrapper>
  <SodokuSolver client:visible />
</MobileWrapper>
...
A few year ago, I implemented a Sodoku solver using Python. 
